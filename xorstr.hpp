 ...
 * 
 * Modified by Dmitry Bolshakov aka DymOK93
 */
...
namespace jm {
    ...
    public:
        ...
        template<class L>
        constexpr XORSTR_FORCEINLINE xor_string( // The original version has no 'constexpr' specifier here due to usage non-constexpr 
												 //::jm::detail::load_from_reg for compatibility with GCC/Clang
            L l,
